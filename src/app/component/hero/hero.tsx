        ...
        <div className="container">
            <div className="row g-5 align-items-center">
                <div className="col-lg-7 col-md-12">
                    ...
                    <a href="" className="btn btn-primary_orange border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">Book Now</a>
                    <a href="" className="btn btn-primary_orange border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">Know More</a>
                </div>
